            ...
            <v-col class="white" cols="8" offset="2">
                        ...
                        <v-col cols="5">
                            ...
                            <v-row justify="space-between">
                                ...
                                <v-tooltip top>
                                    ...
                                    <span
                                        >If unchecked you will be logged out
                                        after 15 minutes of inactivity, you can
                                        change this behaviour in your profile
                                        settings</span
                                    >
                                </v-tooltip>
                            </v-row>
                ...
                <v-row v-show="!just_registered" justify="center" class="mt-12">
                    <v-col cols="3" class="d-flex">
                        ...
                        <v-btn to="/register" class="ml-auto" outlined text
                            >Register</v-btn
                        >
                    </v-col>
                </v-row>
